...
const ERP_CUSTOMER_DESIRED_COLUMNS = [
  'id', 'customer_code', 'name', 'company_name', 'full_name', 'phone', 'fax', 'mobile', 'email',
  'tax_id', 'job_title', 'sales_person', 'billing_customer', 'discount_percent',
  'stop_date', 'invoice_email', 'invoice_mobile', 'carrier_type', 'carrier_code', 'bank_account',
  'payment_method', 'payment_days', 'monthly_closing_day', 'collection_method', 'collection_day',
  'address', 'registered_address', 'invoice_address', 'shipping_address', 'business_address',
  'line_user_id', 'source', 'status', 'display_name', 'customer_stage', 'notes',
];
