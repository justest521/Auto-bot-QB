  ...
  switch (action) {
      ...
      case 'update_sale_invoice': {
        ...
        if (invoice_number) {
          ...
          if (invoice_date) erpInvPayload.invoice_date = invoice_date;
          await supabase.from('erp_invoices').upsert(erpInvPayload, { onConflict: 'invoice_no', ignoreDuplicates: false });
        }
