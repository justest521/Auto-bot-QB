...
export default function AIForecast() {
  ...
  const config = COMING_SOON_TABS.ai_forecast;
          ...
          {config.features.map((f, i) => (
            <div
              ...
              style={{
                ...
                borderBottom: i < config.features.length - 1 ? `1px solid ${t.color.borderLight}` : 'none',
              }}
            >
              <span
                style={{
              ...
              />
              <span style={{ fontSize: isMobile ? t.fontSize.caption : t.fontSize.body, color: t.color.textSecondary, flex: 1 }}>
                {f}
              </span>
